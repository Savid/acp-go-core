...
// eighteen tokens below: every rule this package enforces reports one of them,
...
const (
	...
	// member. Structural validity is checked before ordering.
	ViolationMalformedEnvelope ViolationKind = "malformed_envelope"
	// ViolationUnknownEventType refuses an event type outside the closed five.
	...
	// superseded, and every event for a session whose close completed.
	...
	// carries no difference is suppressed rather than refused.
