...
| `acpcore/usage` and provider subpackages | Bounded provider account readers returning `wire.AccountUsageResponse`; callers supply credentials and an optional HTTP transport. Readers never acquire credentials or launch a harness. |
